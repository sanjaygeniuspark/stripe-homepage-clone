    ...
    <div className="carousel-wrapper number-slider-wrapper">
      ...
      <AnimatePresence custom={direction} mode="wait">
        <motion.div
          ...
          animate="center"
          exit="exit"
          transition={{ duration: transitionDuration, ease: [0.25, 0.8, 0.25, 1] }}
        >
      ...
      <div className="arrows">
        <button onClick={handlePrev} className="arrow left">
          <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
            <path d="M2 6L13 6" stroke="white" strokeWidth="1.75"></path>
            <path
              d="M6 10L2 6L6 2"
              stroke="white"
              strokeWidth="1.75"
        ...
        <button onClick={handleNext} className="arrow right">
          <svg width="14" height="12" viewBox="0 0 14 12" fill="none">
            <path d="M12 6H1" stroke="white" strokeWidth="1.75"></path>
            <path
              d="M8 2L12 6L8 10"
              stroke="white"
              strokeWidth="1.75"
